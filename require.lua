...
function require(module, globals, prerequisite)
   ...
   prerequisite = prerequisite or function() return true end

   local metadata = untouchedScript:match("^%#%[(.-)%]\n")
   local mdata = {}
   ...
   if not prerequisite(mdata) then
      return false, "Script " .. module .. " failed prerequisite"
   end
